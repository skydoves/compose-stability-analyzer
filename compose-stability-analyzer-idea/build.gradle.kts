 ...
 */
plugins {
  // Built with Kotlin 2.4.20 to match the main project. The K2 Analysis API helpers take
  // KaSession as an extension receiver; the context(KaSession) receivers they used before were
  // removed in Kotlin 2.3.20. This module is built separately from the main project.
