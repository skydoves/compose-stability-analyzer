...
**Warning** (the default) displays a yellow underline. This is appropriate for most projects, as it draws attention to instability without being as visually aggressive as an error.
