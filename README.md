...
<p align="center">
  ...
  <a href="https://plugins.jetbrains.com/plugin/28767-compose-stability-analyzer"><img alt="Downloads" src="https://img.shields.io/jetbrains/plugin/d/28767-compose-stability-analyzer.svg"/></a>
...
```toml
stability-analyzer = { id = "com.github.skydoves.compose.stability.analyzer", version = "0.11.1" }
```
